...
<img src="man/figures/README-example-plotting-1.png" alt="" width="100%" />
...
- `compute_all_metrics()` for categorical attributes (integrating
  `compute_Rao()` with distance matrices)
